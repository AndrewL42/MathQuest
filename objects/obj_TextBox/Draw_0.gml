...
if (room == room_challengeAdd or room == room_challengeSub or room == room_challengeSubAdd) {
	...
	draw_text_transformed(x+20,y-100, string(global.highScore), 2, 2, 0);
	draw_text_transformed(x+20,y+60, string(global.count), 2, 2, 0);
...
if (global.correctAnswer == true) {
	...
	draw_text_transformed(x + 70, y + 40,"Correct!", 1, 1, 0);
	global.count += 10;
}
